package com.july.mymall.loginservice.config.rate;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(com.july.mymall.loginservice.config.rate.RateLimit)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rateLimiter.tryAcquire()) {
            ...
            throw new RuntimeException("too many request, please try again later");
        }
    }
}
